...
|---|---|---|---|
| Shennong | `0.2.0.9000`; implementation HEAD `1a9a4bd2c3260d6584c010e884a375b660605223`; Runtime analysis pin `c1d958db3319f635ff5d6f9ad484a208774a4a39` | Both commits are on `origin/main`. The coordination-document commit containing this ledger is intentionally not part of the Runtime package pin. No package release or live deployment was asserted | `test_local`: `PASS 2576`, `FAIL 0`, `WARN 0`, `SKIP 4`; clean staged source `R CMD check` reported `Status: OK`; pkgdown run `30209172802` passed. The R-CMD remote run `30208397436` was blocked by unavailable Bioconductor 3.23 metadata during the unstated-dependency scan, after build/examples/vignettes had passed |
