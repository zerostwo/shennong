...
`speckle` is installed, the same design is also fitted with Propeller. The
contrast is high versus low baseline vaccine response. One donor has cells in
both acquisition batches, so batch is reported above but is not forced into an
invalid one-value-per-sample covariate.
