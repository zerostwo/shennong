...
to one table contract. The common columns include sender, receiver, ligand,
receptor, score, p/q values, rank, method, condition, sample, pathway,
target-gene evidence, evidence source, and a reserved spatial-distance field.
...
ligand-target matrix are supplied. MultiNicheNet requires biological sample
and condition columns and delegates the pseudobulk differential analysis to
...
The sample-evidence table recomputes ligand and receptor expression within
each biological sample. Condition effects therefore use patients or samples as
replicates. They do not treat cells as independent experimental units.
