...
Once the package is installed, you can check whether your local copy is current
and install the preferred release channel directly from R:
...
If you write decontX output back into a Seurat object, the corrected counts are
stored in a separate layer by default and corrected per-cell totals are added
to metadata.
