...
[`sn_enrich()`](https://songqi.org/shennong/reference/sn_enrich.md) now
supports grouped ORA and ranked GSEA through the same `gene_clusters`
formula interface. It can also query multiple databases in one call.
