...
test_that("sn_install_codex_skill installs packaged usage skills into a target directory", {
  ...
  expect_true(file.exists(file.path(target_root, "use-shennong-mcp", "SKILL.md")))
  expect_true(file.exists(file.path(target_root, "use-shennong-mcp", "agents", "openai.yaml")))
