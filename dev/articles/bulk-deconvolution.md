...
#> [1] "/tmp/RtmpFiTjY7/sample_file_for_cibersort.txt"
#> 
#> $mixture
#> [1] "/tmp/RtmpFiTjY7/mixture_file_for_cibersort.txt"
#> 
#> $signature_matrix
#> [1] "/tmp/RtmpFiTjY7/CIBERSORTx_sample_file_for_cibersort_inferred_phenoclasses.CIBERSORTx_sample_file_for_cibersort_inferred_refsample.bm.K999.txt"
#> 
#> $result
#> [1] "/tmp/RtmpFiTjY7/CIBERSORTx_pbmc_demo_Results.txt"
bundle$artifacts$commands
#> $create_signature
#> [1] "docker run -v '/tmp/RtmpFiTjY7':/src/data:z -v '/tmp/RtmpFiTjY7':/src/outdir:z cibersortx/fractions --single_cell TRUE --username 'user@example.org' --token 'replace-with-real-token' --refsample 'sample_file_for_cibersort.txt' --G.min 300 --G.max 500 --q.value 0.01 --filter FALSE --k.max 999 --remake FALSE --replicates 5 --sampling 0.5 --fraction 0.75"
#> 
#> $deconvolve
