...
[`sn_read()`](https://songqi.org/shennong/dev/reference/sn_read.md) can
import. When a Seurat object was initialized from a detected 10x `outs`
directory, stored raw matrix metadata is reused automatically if
`raw = NULL`.
