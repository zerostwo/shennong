...
- pkgdown articles, shipped Codex skill references, and `NEWS.md` are
  ...
  change.
- The pkgdown deployment workflow now installs the current package
  before publishing the site, so reference generation can load
  `Shennong` inside the temporary deployment worktree.
